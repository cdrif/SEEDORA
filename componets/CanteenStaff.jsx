...
export default function CanteenStaff({ schoolSlug }) {
  ...
  const [staffOperator] = useState('Chef Sarah Jenkins (Kitchen ID: SK-884)');
                ...
                <table className="w-full text-left text-xs whitespace-nowrap">
                  <thead>
                    <tr className="text-slate-500 border-b border-slate-900">
                      <th className="pb-2 font-semibold text-[10px] uppercase">Student Name (Primary)</th>
                      ...
                      <th className="pb-2 font-semibold text-[10px] uppercase">Authorized By (Parent Audit)</th>
                  ...
                  <tbody className="divide-y divide-slate-900/60">
                    {ordersHistory.map((ord) => (
                      <tr key={ord.id} className="hover:bg-slate-900/40 transition">
                        <td className="py-3 text-slate-100 font-bold text-sm">{ord.student_name}</td>
                ...
                <table className="w-full text-left text-xs whitespace-nowrap">
                  <thead>
                    <tr className="text-slate-500 border-b border-slate-900">
                      ...
                      <th className="pb-2 font-semibold text-[10px] uppercase">Student Name</th>
                  ...
                  <tbody className="divide-y divide-slate-900/60">
                    {ordersHistory.map((ord) => (
                      <tr key={ord.id} className="hover:bg-slate-900/40 transition">
                        ...
                        <td className="py-3 text-slate-200 font-bold">{ord.student_name}</td>
